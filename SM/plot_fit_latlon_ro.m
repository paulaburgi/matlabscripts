function [dates,perms,c0,mag,time]=plot_fit_latlon_ro(xpt,ypt,pol,pflag)
dirs={'T54','T156','T47'};
%dirs=dirs(1:2);

%%%%%%%%% NOTE: MDX ROW, COL = 1+XPT, 1+YPNT (so add 1 to row/col values to
%%%%%%%%% plug into xpt, ypt) also: col = x=col, y=row
