...
geefol = [datafol 'analysis/geotiff_cor_gee/']; 


cd(intfol);  
csv_all = [geefol 'meta_cor_all.csv'];
...
overwrite = 1; %overwrite current concatenated csv file? 
...
for i=1:length(bl); 
    ...
    % import csv
    csvi = importdata('meta_topophase.cor.geo.csv'); 
    ni   = csvi.data; 
    nt   = csvi.textdata; 
